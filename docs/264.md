...
Example: Class<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> 
...
Example: Class without Constructor<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> 
...
Example: Create an Object<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> 
...
在上面的例子中，我们向对象传递值来初始化成员变量。当我们实例化一个新对象时，用传递的值调用类构造函数，并用这些值初始化成员变量`empCode`和`empName`。
...
Example: Implement Interface<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> 
...
Example: Interface Extends Class<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> 
...
Example: Method Overriding<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> 
