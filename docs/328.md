...
Example: Raise and Handle Node.js events<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> 
...
Example: EventEmitter<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> 
...
Example: Return EventEmitter from a function<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> 
...
Example: Extend EventEmitter Class<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> 
