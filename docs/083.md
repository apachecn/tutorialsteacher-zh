...
> 原文：<https://www.tutorialsteacher.com/core/fundamentals-of-logging-in-dotnet-core>
 ...
 .NET Extensions 是一组开源的、跨平台的 API，用于常用的编程模式和实用程序，如依赖注入、日志记录和应用配置。这个项目中的大多数API都可以在许多平台上运行 .NET 平台，例如 .NET Core， .NET 框架、Xamarin 和其他。虽然这些应用接口通常用于 ASP.NET Core 应用，但并不与 ASP.NET Core 应用模型相耦合。它们可以用于控制台应用、WinForms 和 WPF 等。您可以在[https://github.com/aspnet/Extensions](https://github.com/aspnet/Extensions)找到扩展的文档和源代码。
...
日志API包含在`Microsoft.Extensions.Logging`包中。日志API不能独立工作。它与一个或多个将日志存储或显示到特定介质(如控制台、调试、跟踪侦听器等)的日志提供程序一起工作。
...
[![](img/f160d60cef903627bed96c38f3602aeb.png)](../../Content/images/core/logging-dotnet-core.png) 
...
[![Logging API .NET Core](img/b03d59bdfde5f47e27e48ec0cf100689.png)](../../Content/images/core/logging-api.png) 
...
[![Logging in ASP.NET Core](img/b95e01d312eb0407e12c49e3ad620b0a.png)](../../Content/images/core/console-logger.png) 
...
[![](img/76120b26e17f75dd7f3f71db1b5d5620.png)](../../Content/images/core/example-output.png) 
