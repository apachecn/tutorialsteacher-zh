...
> 原文:[https://www . tutorial stearn . com/linq/linq-聚合-运算符-计数](https://www.tutorialsteacher.com/linq/linq-aggregation-operator-count)
...
Output:<samp>Total Students: 5</samp>*Note:**Count(predicate) extension method with predicate parameter is **Not Supported** in VB.Net.* *## 查询语法中的计数运算符
...
Output:<samp>Total Students: 3</samp>
