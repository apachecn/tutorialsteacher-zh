...
> 原文:[https://www . tutorial stearn . com/linq/linq-partitioning-operators-skip while](https://www.tutorialsteacher.com/linq/linq-partitioning-operators-skip-skipwhile)
