...
如上所述，Edit()操作方法包含 id 参数。此 id 参数将绑定到查询字符串 id 参数。我们使用这个 id 通过 HttpClient 从数据库中获取学生记录，并在编辑视图中传递学生记录。访问 [HttpClient](/webapi/consuming-web-api-in-dotnet-using-httpclient) 部分了解更多信息。
