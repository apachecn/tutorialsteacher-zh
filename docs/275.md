...
Example: Set compilerOptions in tsconfig.json<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> 
...
Example: files in tsconfig.json<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> 
