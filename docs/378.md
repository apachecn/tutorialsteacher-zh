...
<figure>[![](img/1b71b99486e37561b8396f1b807ef2c0.png)](../../Content/images/sass/hue-color.png)</figure>

饱和度是颜色中“多少”色调的量度——它是强度。想想日落时颜色会发生什么。颜色越纯，饱和度越高。

<figure>[![](img/a0606d3183b508ceb610d7f42c7ebbe6.png)](../../Content/images/sass/saturation-color.png)</figure>

最后一个成分，价值，是衡量一种颜色的明度或暗度。想象一棵树，它的一些叶子在明亮的光线下，一些叶子在阴影中:

<figure>[![](img/a708968464e5e079d4db6f116a6aebd0.png)](../../Content/images/sass/value-color.png)</figure>
...
<figure>[![hsl color wheel](img/36a838ad18b9136fbebda501a9ba937e.png)](../../Content/images/sass/hsl-wheel.png)</figure>

可以在显示器上显示的任何颜色(有些不能)都可以使用以下任一模型来表示:

<figure>[![color models](img/24d020adf62ad881677f6982ebe9e690.png)](../../Content/images/sass/color-models.png)</figure>
...
<figure>[![](img/1f9e3fb39ef33f0882b4ba299009f033.png)](../../Content/images/sass/opecity.png)</figure>
