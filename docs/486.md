...
Example: Create List of Even Numbers without List Comprehension<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> *```
even_nums = []
for x in range(21):
    if x%2 == 0:
        even_nums.append(x)
...
Example: Create List of Even Numbers with List Comprehension<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> *```
...
Example: List Comprehension with String List<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> *```
...
Example: List Comprehension<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> *```
