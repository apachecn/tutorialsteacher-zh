...
<figure>[![sample partial view](img/7953c6692cd2ec3e09c4d7d88b13a348.png)](../../Content/images/mvc/partial-view-1.png) 

<figcaption>Partial View</figcaption>

</figure>

我们之前创建了我们的第一个 MVC 应用程序。打开`_Layout.cshtml`文件，你会看到上面菜单栏的如下 HTML 代码。 我们将在单独的局部视图中剪切并粘贴该代码。

<figure>[![](img/9d05ab0d4d3f9ec2df26ad1157d82217.png)](../../Content/images/mvc/partial-view-2.png) 

<figcaption>Partial Views</figcaption>
...
<figure>[![Adding a partial view](img/a69e202824c0efe3900c0d6c305082fe.png)](../../Content/images/mvc/add-partial-view.png) 

<figcaption>Add Partial View</figcaption>
...
_MenuBar.cshtml<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> *```
...
_MenuBar<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> *```
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
...
Example: Html.RenderPartial()<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> *```
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
...
<figure>[![](img/7ea72d6650ea44f872f0779b311150ba.png)](../../Content/images/mvc/partial-view-5.png) </figure>
