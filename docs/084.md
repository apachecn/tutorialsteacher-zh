...
Example: Program.cs<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> *```
...
Example: Startup.cs<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> *```
...
Example: Logging in MVC Controller<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> *```
