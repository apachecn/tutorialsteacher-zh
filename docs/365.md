...
<figure>[![Start Ruby Command Prompt in Windows](img/58a1f595a3a74db2cb43b9755a3578df.png)](../../Content/images/sass/start-ruby-command-prompt.png)

<figcaption>Start Ruby Command Prompt in Windows</figcaption>
