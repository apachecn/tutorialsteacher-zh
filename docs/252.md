...
Example: never<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> 
...
Example: never vs void<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> 
