...
在上一节中，您学习了使用Web API动作方法进行参数绑定。在这里，您将了解动作方法的返回类型，这些返回类型又将嵌入到发送给客户端的Web API响应中。

Web API动作方法可以有以下返回类型。
...
[![](img/ceb18322304c6dedeb9a3ec5fe725c55.png)](../../Content/images/webapi/void-response-status.png)
...
[![](img/8e797a1592c8942734871fda35b71e2f.png)](../../Content/images/webapi/primitive-return-type-response.png)
...
[![](img/75b71c9d214f5600b4bd764601b084f0.png)](../../Content/images/webapi/primitive-return-type-response2.png)
...
Web API 控制器总是向宿主基础结构返回一个 HttpResponseMessage 对象。下图说明了整个Web API请求/响应管道。
...
[![](img/0b5c2cb438e56077ce227bdcadfbd2fe.png)](../../Content/images/webapi/httpresponsemessage1.png)
...
[![](img/3a569b8575da15184d71b64d65c19a23.png)](../../Content/images/webapi/httpresponsemessage2.png)
