...
Example: Variable Declaration using let<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> 
...
Example: let Variables Scope<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> 
...
Example: var Variables Scope<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> 
...
Example: let vs var<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> 
...
Example: Multiple Variables with the Same Name<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> 
...
Example: Same Variable Name in Different Blocks<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> 
...
Example: Const Variable<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> 
...
Example: const Object<button class="copy-btn pull-right" title="Copy example code">*Copy*</button> 
